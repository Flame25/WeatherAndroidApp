...
class MainActivity : AppCompatActivity() {
    ...
    val API: String = "349988f1b6aea1332091205112c7d309"
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>()
    {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try{
                ...
                val updatedAtText = "Updated at: " + SimpleDateFormat("dd/MM/yyyy hh:mm a",Locale.ENGLISH).format(Date(updatetAt * 1000))
                ...
                findViewById<TextView>(R.id.sunrise).text = SimpleDateFormat("hh:mm a", Locale.ENGLISH).format(Date(sunset*1000))
